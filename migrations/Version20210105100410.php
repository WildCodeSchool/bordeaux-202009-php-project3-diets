 ...
 */
final class Version20210105100410 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, picture_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, link VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, service_is_validated TINYINT(1) DEFAULT NULL, INDEX IDX_E19D9AD2A76ED395 (user_id), UNIQUE INDEX UNIQ_E19D9AD2EE45BDBF (picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
